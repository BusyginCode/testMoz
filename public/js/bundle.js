...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mContentJsx = __webpack_require__(165);
	
	var _mContentJsx2 = _interopRequireDefault(_mContentJsx);
	...
	var App = (function (_React$Component) {
		...
		function App() {
			...
			this.getShowType = function (type) {
				_this.setState({
					clickCheck: type
				});
			};
		...
		_createClass(App, [{
			...
			value: function render() {
				return _react2['default'].createElement(
					'div',
					{ className: '' },
					_react2['default'].createElement(_filtr_butFiltr_but2['default'], { getShowType: this.getShowType }),
					this.state.clickCheck ? _react2['default'].createElement(_filtrFiltr2['default'], { showType: this.state.showType }) : _react2['default'].createElement(_mContentJsx2['default'], { contWidth: 1000 })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FiltrBut = (function (_React$Component) {
		...
		function FiltrBut() {
			...
			this.changeShowStyleM = function () {
				// this.props.getShowType('element_mozaik', 'elem_name_m', 'img_div_m', 'elem_img_m', 'el_count_m', 'el_discont_m', 'elem_price_m','about_m');
				_this.props.getShowType(false);
			};
	
			this.changeShowStyleN = function () {
				_this.props.getShowType(true);
		...
		_createClass(FiltrBut, [{
			...
			value: function render() {
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						'span',
						{ className: 'change_show_style' },
						_react2['default'].createElement(
							'a',
							{ className: 'mozaik_show_but change_show', onClick: this.changeShowStyleM },
							'M'
						),
						_react2['default'].createElement(
							'a',
							{ className: 'normal_content_show change_show', onClick: this.changeShowStyleN },
							'N'
						)
					),
		...
		_createClass(Filter, [{
			...
			value: function render() {
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(_contentContent2['default'], { filtrObject: this.state.locationFiltr, setFiltr: this.setFiltr, showType: this.props.showType }),
					_react2['default'].createElement(
						'div',
						{ className: 'show_cont' },
						_react2['default'].createElement(
	...
	var Content = (function (_React$Component) {
			...
			function Content() {
					...
					this.componentDidUpdate = function () {
							// show/hint button
							if (_this.defaultProps.j <= _this.defaultProps.i) {
					...
					this.calculateFiltr = function () {
													...
													if (datum.price < max && datum.price > min || !_this.props.filtrObject.max) {
															if (datum.price > min || !_this.props.filtrObject.min) {
																	if (datum.name.indexOf(_this.props.filtrObject.name) + 1 || !_this.props.filtrObject.name) {
																			++_this.defaultProps.j;
																			if (_this.defaultProps.i < _this.props.filtrObject.renderCount) {
																					++_this.defaultProps.i;
																					return _react2['default'].createElement(_elementElement2['default'], { name: datum.name, img_s: datum.img, price: datum.price, count: datum.count, deal: datum.deals, showType: _this.props.showType });
																			}
																	}
															}
													}
							...
							return _this.showHint(filtr, _this.defaultProps.i);
					};
	
					this.showHint = function (filtr, i) {
							if (i) {
									return filtr;
							} else {
									return _react2['default'].createElement(
	...
	var Element = (function (_React$Component) {
		...
		_createClass(Element, [{
			...
			value: function render() {
				...
				return _react2['default'].createElement(
					'div',
					{ className: this.props.showType.type },
					_react2['default'].createElement(
						'a',
						{ href: this.props.hr },
						_react2['default'].createElement(
							'h3',
							{ className: this.props.showType.name },
							this.props.name
						),
						_react2['default'].createElement(
							'div',
							{ className: this.props.showType.img_div },
							_react2['default'].createElement('img', { src: this.props.img_s, className: this.props.showType.img })
						),
						_react2['default'].createElement(
							'div',
							{ className: this.props.showType.about },
							_react2['default'].createElement(
								'div',
								{ className: this.props.showType.count },
								'Кол-во на складе: ',
								this.props.count
							),
							_react2['default'].createElement(
								'div',
								{ className: this.props.showType.discont },
								'Скидка: ',
								this.props.deal ? 'Есть ' : 'Нет'
							),
							_react2['default'].createElement(
								'h5',
								{ className: this.props.showType.price },
								'Цена: ',
								this.props.price
							)
						)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Content = (function (_React$Component) {
			...
			function Content() {
					...
					this.calculateFiltr = function () {
							//fields filtration
							var mount_content = _this.state.data.products;
							var contWidth = _this.props.contWidth,
							    renderWidth = 0,
							    elemWidth = 0,
							    colRender = 0,
							    renderElem = {},
							...
							var filtr = mount_content.map(function (datum) {
									...
									if (renderWidth >= contWidth) {
											...
											renderElem = _react2['default'].createElement(
													'div',
													{ id: 'this.defaultProps.i', style: { width: datum.width + 'px' }, className: 'first' },
													_react2['default'].createElement('img', { src: datum.img, id: _this.defaultProps.i, style: { width: datum.width + 'px' } }),
													_react2['default'].createElement(
															'div',
															{ className: 'd_show', style: { width: datum.width + 'px' } },
															_react2['default'].createElement(
																	'span',
																	null,
																	datum.name,
											...
											if (datum.width <= contWidth - renderWidth) {
													...
													renderElem = _react2['default'].createElement(
															'div',
															{ id: 'this.defaultProps.i', style: { width: datum.width + 'px' } },
															_react2['default'].createElement('img', { src: datum.img, id: _this.defaultProps.i, style: { width: datum.width + 'px' } }),
															_react2['default'].createElement(
																	'div',
																	{ className: 'd_show', style: { width: datum.width + 'px' } },
			...
			_createClass(Content, [{
					...
					value: function render() {
							return _react2['default'].createElement(
									'div',
									{ id: 'content_m', style: { width: this.props.contWidth + 'px' } },
									this.calculateFiltr()
							);
					}
			}]);
